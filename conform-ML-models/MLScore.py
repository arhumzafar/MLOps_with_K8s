##Arhum Zafar -- delete
## TODO: Add bash_operator and file sensor when Model has conformed to DAG.


"""
We define a class that integrates with the Seldon core interface for the ML Model.
"""
